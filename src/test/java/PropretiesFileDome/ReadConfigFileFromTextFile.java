...
public class ReadConfigFileFromTextFile {

	 //properties class variable  for reading proerties from properties file
		Properties properties;
		
		//path of config data stored in project configText.txt file
		String path="C:\\Users\\mdjav\\eclipse-workspace\\seleniumAutomationProject\\src\\test\\java\\PropretiesFileDome\\ConfigText.txt";
		 
		//creaing constructor to load confic file 
		public ReadConfigFileFromTextFile() 
		{
